...
main{max-width:1400px;margin:auto;padding:24px}h1{margin:0 0 20px;font-size:24px}.cards{display:grid;grid-template-columns:repeat(4,1fr);gap:14px}
...
@media(max-width:900px){.cards{grid-template-columns:repeat(2,1fr)}.grid{grid-template-columns:1fr}}@media(max-width:520px){.cards{grid-template-columns:1fr}}
</style>
</head>
<body><main>
<h1>Immich Optimizer</h1>
<section class="cards">
<div class="card"><div class="label">Processed</div><div class="value" id="count">0</div></div>
<div class="card"><div class="label">Original Size</div><div class="value" id="original">0 B</div></div>
